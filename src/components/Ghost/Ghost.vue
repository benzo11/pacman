<template>
  <div
    ...
    class="figure__ghost"
    v-bind:class="['movement__']"
  >
    <svg
      id="Layer_1"
      data-name="Layer 1"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 1510.15 1279.17"
      v-bind:class="['ghost__' + type]"
    >
      <defs></defs>
      <path
        class="cls-1"
...
export default {
  name: "Ghost",
  mounted: function () {
    this.type = this.$props.ghostType;
  ...
  methods: {
    changeDirection() {
      ...
      this.movement = arrayOfMovement[movement];
    },
    move() {
        ...
        case "right":
          this.position = {
            ...
            left: Math.min(
              ...
              window.innerWidth - this.border - this.ghostSize
            ),
          };
          break;
        case "left":
